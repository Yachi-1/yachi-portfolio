        ...
        <div style={{ position: "relative", maxWidth: 1400, margin: "0 auto" }}>
          ...
          <motion.div
            ...
            style={{
              ...
              padding: isMobile ? "12px 12px 14px" : "20px 20px 22px",
              boxShadow: mode === "dark"
          ...
          >
            <div style={{ marginBottom: isMobile ? 10 : 16 }}>
              <div style={{ fontFamily: "'Caveat', cursive", fontSize: isMobile ? 18 : 24, fontWeight: 500, color: theme.accent, lineHeight: 1 }}>education ✿</div>
            </div>
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontFamily: "Inter", fontSize: 7.5, fontWeight: 800, letterSpacing: 0.8, textTransform: "uppercase", color: theme.inkMute, opacity: mode === "dark" ? 1 : 0.7, marginBottom: 3 }}>
                  Bachelor's
                </div>
                <div style={{ fontFamily: "Inter", fontSize: 11, fontWeight: 700, color: theme.ink, lineHeight: 1.2, marginBottom: 6 }}>
          ...
          >
            ...
            <div style={{ marginBottom: isMobile ? 10 : 14 }}>
              <div style={{ fontFamily: "'Caveat', cursive", fontSize: isMobile ? 18 : 24, fontWeight: 500, color: theme.accent, lineHeight: 1 }}>experience ✿</div>
            </div>
            ...
            {[
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontFamily: "Inter", fontSize: 8.5, color: "#3A2D00", opacity: 0.85, lineHeight: 1.25 }}>@{item.company}</div>
                </div>
                <div style={{
          ...
          <div style={{
            ...
            <Reveal delay={0.6}>
              <div style={{ display: "flex", gap: 14, alignItems: "center", marginTop: 36 }}>
                <MagneticButton theme={theme} primary onClick={() => { setRoute("projects"); window.lenis?.scrollTo(0); }}>
                  See my work <ArrowRight size={16} />
                </MagneticButton>
                <MagneticButton theme={theme} onClick={() => { setRoute("about"); window.lenis?.scrollTo(0); }}>
                  About me
                </MagneticButton>
              </div>
            </Reveal>
